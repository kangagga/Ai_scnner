...
#                filtered_sig = filtered_sig[:sisa]
            ...
            try:
                ...
                for sig in filtered_sig:
                    ...
                    # [FIX 2026-07-08] Veto liquidity/slippage sebelum eksekusi.
                    # Kasus nyata: YFIUSDT liq_score=4/10, slippage=6.345% tetap
                    # auto-eksekusi karena level "SIAP ENTRY — KONFIRMASI DULU"
                    # diperlakukan sama seperti EKSEKUSI (tidak ada gerbang nyata).
                    liq_score = sig.get("liq_score", 5)
                    slippage  = sig.get("slippage_est", 0)
